...
HD_PWD='C:/Xilinx/Vivado/2021.1/myDev/clock_divider_v1/clock_divider_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_divider_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_divider_v1.tcl
